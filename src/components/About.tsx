...
export default function About() {
  ...
  // Mirrors Tailwind's `lg` breakpoint (1024px), used only to decide whether
  // scroll should auto-turn page 1→2 (desktop) or leave turning entirely to
  // the reader's own swipe/tap (mobile) — the notebook's own responsive
  // sizing (width/portrait mode) is handled natively by react-pageflip and

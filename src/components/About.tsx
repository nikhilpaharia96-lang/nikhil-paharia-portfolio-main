          ...
          >
            ...
            >
              ...
              <motion.div
                ...
                className="lg:col-span-2 relative px-6 py-8 sm:px-10 sm:py-10 border-t border-dashed border-slate-300/60"
              >
                ...
                {/* Final Phase — torn-paper style ending banner, matching the
                    reference design */}
                <motion.div

...
/* ── Lighter child variant for small inline items (nav links, icon
   buttons, chips) — same cinematic ease and stagger rhythm as cinChild,
   but a shorter throw and quicker settle so small UI doesn't feel like
   it's overshooting relative to its own size. ── */
export const cinChildSmall = {

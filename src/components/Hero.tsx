...
const socials = [
  ...
  { icon: <FaInstagram />,  href: "https://www.instagram.com/nikhil.paharia_/",       label: "Instagram", color: "text-pink-500"  },
  { icon: <FaYoutube />,    href: "https://www.youtube.com/@nikhil.paharia",             label: "YouTube",   color: "text-red-500"   },

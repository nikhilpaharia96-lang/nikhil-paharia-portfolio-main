...
import blueBrush from "../assets/images/blue-brush-stroke.png";
import threeStrokes from "../assets/images/three-strokes.png";
import assamMap from "../assets/images/assam-map.svg.png";
    ...
    >
      ...
      <div className="hidden lg:block absolute inset-0">
        ...
        <div className="absolute inset-y-0 right-0 w-[62%] overflow-hidden pointer-events-none">
          ...
          {/* Blue brush stroke — white background removed via mix-blend-mode multiply */}
          <div className="absolute inset-0 flex items-end justify-center" style={{ mixBlendMode: "multiply" }}>
            <img
              src={blueBrush}
              alt=""
              aria-hidden="true"
        ...
        >
          <div className="relative flex-shrink-0 w-14 h-14">
            <img src={assamMap} alt="" aria-hidden="true" className="w-full h-full object-contain" style={{ mixBlendMode: "multiply" }} />
